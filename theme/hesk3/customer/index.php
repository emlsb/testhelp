            ...
            <div class="contr">
                <div class="header__inner">
                    <a href="<?php echo $hesk_settings['hesk_url']; ?>" class="header__logo">
                        <img src="<?php echo $hesk_settings['hesk_url']; ?>/img/HeadLogoRD.png" alt="<?php echo $hesk_settings['hesk_title']; ?>">
                    </a>
        ...
        <div class="main__content">
            <div class="contr">
                ...
                <div class="nav">
                    ...
                    <a href="my_tickets.php" class="navlink" class="navlink">
                        <div class="icon-in-circle">
					...
					<a href="http://rd-redmine.red-dolphin.ru/" class="navlink" target="_blank" rel="noopener noreferrer">
                        <div class="icon-in-circle">
                            <svg class="icon icon-document">
                                <use xlink:href="<?php echo TEMPLATE_PATH; ?>customer/img/sprite.svg#icon-anonymize"></use>
                            </svg>
                        </div>
                        <div>
                            <h5 class="navlink__title">
							Redmine
							<?php //echo $hesklang['view_existing_tickets']; ?>
							</h5>
                            <div class="navlink__descr">
					...
					<a href="knowledgebase.php?article=21" class="navlink">
                        <div class="icon-in-circle">
                            <svg class="icon icon-document">
                                <use xlink:href="<?php echo TEMPLATE_PATH; ?>customer/img/sprite.svg#icon-menu-mobile"></use>
                            </svg>
                        </div>
                        <div>
                            <h5 class="navlink__title">
					...
					<a href="http://checkwork.red-dolphin.ru/PublicPages/Registration.aspx" class="navlink" target="_blank" rel="noopener noreferrer">
                        <div class="icon-in-circle">
                            <svg class="icon icon-document">
					...
					<a href="http://buyer.red-dolphin.ru" class="navlink" target="_blank" rel="noopener noreferrer">
                        <div class="icon-in-circle">
                            <svg class="icon icon-document">
